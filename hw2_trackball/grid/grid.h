...
public:
    void Init() {
        ...
        // vertex coordinates and indices
        {
            ...
            int grid_dim = 101;      // number of lateral vertices
...
//                cout<<vertices.at(0)<< ", " << vertices.at(1) << endl;
//                cout<<vertices.at(2)<< ", " << vertices.at(3) << endl;
//                cout << vertices.at(vertices.size()-4)<< ", " << vertices.at(vertices.size()-3) << endl;
//                cout<< "size : " << vertices.size()<< " / " << vertices.at(vertices.size()-2)<< ", " << vertices.at(vertices.size()-1) << endl;
